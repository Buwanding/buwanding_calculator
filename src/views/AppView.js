            ...
            <div className="row justify-content-center">
              <div className="col-md-5">
                ...
                <div className="app-header">
                    <span className="app-title">Buwanding</span> Calculator 
                ...
                <p className="copy-right text-right">
                    &copy; 2023, <a href="https://github.com/Buwanding/buwanding_calculator.git" target="_blank">Aladdin Buwanding </a>
                </p>
            </div>
            </div>
        </div>
